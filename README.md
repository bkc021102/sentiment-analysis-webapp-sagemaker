...
Maintained by KRISHNA CHAITANYA BHUPATHI RAJU.
...
This project is actively maintained by KRISHNA CHAITANYA BHUPATHI RAJU. Krishna is a Data Analyst with over 3 years of experience, specializing in SQL, Python, Power BI, and Tableau for advanced analytics across financial, operational, and healthcare data. His expertise includes ETL/ELT, data quality, data governance, data modeling, data pipelines, and machine learning within Agile environments.

Key Skills: Python, SQL, Advanced SQL, PostgreSQL, Pandas, NumPy, Scikit-learn.

Connect with Krishna:
- LinkedIn: https://www.linkedin.com/in/bkrishna-chaitanya/
